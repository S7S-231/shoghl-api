...
* The original package name 'com.shoghl.shoghl-api' is invalid and this project uses 'com.shoghl.shoghl_api' instead.
...
* [Docker Compose Support](https://docs.spring.io/spring-boot/3.5.12/reference/features/dev-services.html#features.dev-services.docker-compose)
